...
class VisasControllerTest < ActionController::TestCase
  ...
  test "should create visa" do
    assert_difference('Visa.count') do
      post :create, visa: { category: @visa.category, desc: @visa.desc, name: @visa.name, price: @visa.price }
    end
  ...
  test "should update visa" do
    patch :update, id: @visa, visa: { category: @visa.category, desc: @visa.desc, name: @visa.name, price: @visa.price }
    assert_redirected_to visa_path(assigns(:visa))
  end
